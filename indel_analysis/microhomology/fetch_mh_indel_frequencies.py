...
if len(sys.argv) != 2:
    print('Usage: fetch_mh_indel_frequencies.py subdir')

else:

    subdir = sys.argv[1]
    outdir = createResultDirectory('mh_indel_frequencies', subdir, with_subdir=True)
    ...
    for indel_file in indel_files:
        ...
        mh_indels = loadMhExpIndels(mh_exp_indels_file, set(oligo_ids))
